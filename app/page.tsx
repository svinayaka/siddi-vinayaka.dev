  ...
  return (
    <div className="main_container">
      ...
      <main>
        ...
        {/* === ABOUT SECTION === */}
        <section id="about" className="border-t border-gray-200 dark:border-gray-800 pt-16">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-6">About Me</h2>

          <div className="space-y-4 text-gray-600 dark:text-gray-300 max-w-3xl">
        ...
        {/* === CONTACT SECTION === */}
        <section id="contact" className="border-t border-gray-200 dark:border-gray-800 pt-16 mt-16 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                  ...
                  <a href="mailto:siddi.vinayaka@example.com" className="hover:text-blue-600 dark:hover:text-blue-400 transition">
                ...
                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                  ...
                  <a href="https://www.linkedin.com/in/siddhivinayaka" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 dark:hover:text-blue-400 transition">
            ...
            {/* Contact Form */}
            <form className="space-y-4 bg-gray-50 dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-black text-gray-900 dark:text-white transition outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  required
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-black text-gray-900 dark:text-white transition outline-none resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 dark:bg-blue-700 text-white font-medium py-2.5 px-4 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition shadow-sm cursor-pointer"
              >
                Send Message
              </button>
            </form>
